...
export const metadata: Metadata = {
  ...
  description: "Mentions légales du site mkrcaucasiancamp.com. Éditeur, hébergeur, responsable de publication, droits d'auteur.",
    ...
    <section className="legal-page">
      <div className="inner">
        ...
        <div className="legal-content">
          ...
          <p>MKR Caucasian Camp<br/>Adresse : [À compléter]<br/>Email : contact@mkrcaucasiancamp.com<br/>Responsable de la publication : [À compléter]</p>
