...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/familles`, lastModified: '2026-04-30', changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${base}/destinations`, lastModified: '2026-04-30', changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/destinations/dagestan`, lastModified: '2026-04-30', changeFrequency: 'monthly', priority: 0.8 },
