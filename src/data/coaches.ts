...
export const COACHES: Coach[] = [
  {
    ...
    bio: "Champion du Daghestan en lutte libre, multiple medaille aux Jeux du Caucase. 18 ans d'entraînement a Makhachkala. Sa méthode : intensite maximale, precision absolue.",
    bioShort: "Champion du Daghestan en lutte libre, multiple medaille aux Jeux du Caucase. 18 ans d'entraînement. Formateur equipe junior daghestanaise.",
  ...
  },
  {
    ...
    discipline: 'Boxe',
    jobTitle: 'Coach Boxe',
    bio: "Ex-boxeur professionnel, 22 combats. Aujourd'hui il affute la precision des poings de la prochaine génération a Makhachkala. Son travail aux mitaines est legendaire dans la region.",
