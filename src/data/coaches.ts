...
export const COACHES: Coach[] = [
  ...
  },
  {
    ...
    discipline: 'MMA',
    jobTitle: 'Coach MMA',
    bio: 'Veteran du circuit MMA caucasien, 14 victoires professionnelles. Specialiste des transitions sol-debout. Forme a Grozny, enracine dans la tradition guerriere tchetchene.',
  ...
  },
  {
    ...
    discipline: 'Boxe',
    jobTitle: 'Coach Boxe',
    bio: "Ex-boxeur professionnel, 22 combats. Aujourd'hui il affute la precision des poings de la prochaine generation a Grozny. Son travail aux mitaines est legendaire dans la region.",
