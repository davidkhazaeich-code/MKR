...
export const COACHES: Coach[] = [
  {
    ...
    bio: "Champion de Géorgie, 3x médaillé aux championnats d'Europe juniors. 18 ans d'entraînement en salle. Sa méthode : brutalité contrôlée, précision absolue.",
  ...
  },
  {
    ...
    bio: "Maître du Sambo depuis 1998. Projections, soumissions debout et au sol. Il maîtrise les deux dimensions. Disciple de la tradition martiale soviéto-caucasienne.",
