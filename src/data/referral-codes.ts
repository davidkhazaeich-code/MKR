...
export const REFERRAL_CODES: ReferralCode[] = [
  ...
  },
  {
    ...
    bonusEur: 0,
    active: true,
    notes: 'Lutteur champion - Tchélyabinsk (oblast 74). Forfait 0 EUR (décision David 2026-06-16) : code actif uniquement pour tracer les leads, aucune commission versée.',
